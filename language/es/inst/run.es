md5="7e827cb82e797616c1385410574be9a6";rev="7239";by="Javier Enciso <j4r.e4o@gmail.com>"
-*- texinfo -*-
@deftypefn {Archivo de función} {} run (@var{f})
@deftypefnx {Comando} {} run @var{f}
Ejecuta los scripts en el espacio de trabajo actual que no están 
