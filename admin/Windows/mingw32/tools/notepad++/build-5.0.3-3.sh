...
URL="http://downloads.sourceforge.net/notepad-plus/npp.5.0.3.src.zip http://downloads.sourceforge.net/notepad-plus/npp.5.0.3.bin.zip"
...
PLUGINS="WindowManager_1_1_2_dll FunctionList_1_2_dll HexEditor_0_9_0_dll"
PLUGINS_URL=" \
http://downloads.sourceforge.net/npp-plugins/WindowManager_1_1_2_dll.zip \
http://downloads.sourceforge.net/npp-plugins/FunctionList_1_2_dll.zip \
