...
C Based on SLICOT RELEASE 5.0, Copyright (c) 2004-2010 NICONET e.V.
C
C Matlab call:
...
C
C Revisions:
C   V. Sima, April 2004, Sept. 2004, Mar. 2005, Apr. 2009.
C
C***********************************************************************
C
...
C .. Mex-file integer functions ..
      INTEGER           mxCreateDoubleMatrix, mxGetPr, mxGetM, mxGetN
