...
create_fltk() {
  ...
  cd ./work/fltk-1.1.9
  # conf_make_inst "$vcnf --enable-quartz --enable-gl --without-x \
  #   --enable-shared --disable-static"
  conf_make_inst "$vcnf --enable-threads --without-x --enable-shared --disable-static"
...
create_octave() {
  ...
  voct=(octave-3.1.53.tar.gz 248be566be0be05d7d543dafeb5948ad)
  vopc=(./patches/octave-3.1.53.diff.gz 8d5d0cb8e7459f07f5d6ddaaee2d35b7)
