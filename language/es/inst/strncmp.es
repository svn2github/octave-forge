md5="0611e633c011b1bed3176fc22527728c";rev="7240";by="Javier Enciso <j4r.e4o@gmail.com>"
-*- texinfo -*-
@deftypefn {Archivo de función} {} strncmp (@var{s1}, @var{s2}, @var{n})
...
cadena de caracteres. El otro argumento también puede ser una matriz
...
@strong{Preacaucion:} Para la compatibilidad con @sc{Matlab},la función
Octave strncmp devuelve 1 si las cadenas de caracteres son iguales, y 0 en
caso contrario. Esto es justo lo contrario de la función C correspondiente
a la biblioteca.
