...
## ThDDGOXelectron_driftdiffusion(@var{mesh},@var{Dsides},@var{n},@var{pin},@var{V},@var{Tn},@var{mobn0},@var{mobn1},@var{tn},@var{tp},@var{n0},@var{p0})
##
## Input:
## @itemize @minus
...
function n = ThDDGOXelectron_driftdiffusion(mesh,Dnodes,n,pin,V,Tn,mobn0,mobn1,tn,tp,n0,p0)
  ...
  n(Varnodes) = LHS(Varnodes,Varnodes) \(RHS(Varnodes) - LHS(Varnodes,Dnodes)*n(Dnodes));
