...
THISSCRIPT=solvedeps-2.9.18.sh
...
#OCTAVEPACK=ftp://ftp.octave.org/pub/octave/octave-2.9.18.tar.gz
OCTAVEPACK=./octave-2.9.18.tar.gz
OCTAVEDIFF=./octave-2.9.18.diff
