...
* third argument is a cell array with 10 elements that controls\n\
	...
	* eps -  0 < eps: the required tolerance level for function value comparisons\n\
...
control = {lb, ub, nt, ns, neps, rt, \n\
	maxevals, eps, verbosity, minarg};\n\
\n\
