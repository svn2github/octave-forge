md5="c34e3ab084588dd53930f40f939252fc";rev="7240";by="Javier Enciso <j4r.e4o@gmail.com>"
-*- texinfo -*-
@deftypefn {Función cargable} {@var{y} =} spsumsq (@var{x},@var{dim})
...
@end example
pero usa menos memoria y evita los llamados a la función @code{spconj} si 
@var{x} es real.
