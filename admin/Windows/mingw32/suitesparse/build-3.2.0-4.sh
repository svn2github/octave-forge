...
install_lib_core()
{
   ...
   ${CP} ${CP_FLAGS} ${BUILDDIR}/$1/lib/lib$1.a ${STATICLIB_PATH}
}
...
uninstall_lib_core()
{
   ...
   ${RM} ${RM_FLAGS} ${STATICLIB_PATH}/lib$1.a 
}

install_header_core()
{
   for a in $2; do 
      ${CP} ${CP_FLAGS} ${SRCDIR}/$1/Include/$a ${INCLUDE_PATH}
   done
}
...
uninstall()
{
   ...
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/LICENSE.AMD
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/LICENSE.CAMD
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/Readme.CCOLAMD
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/LICENSE.CHOLMOD.Check
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/LICENSE.CHOLMOD.Cholesky
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/LICENSE.CHOLMOD.Core
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/LICENSE.CHOLMOD.Demo
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/LICENSE.CHOLMOD.MatrixOps
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/LICENSE.CHOLMOD.Modify
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/LICENSE.CHOLMOD.Partition
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/LICENSE.CHOLMOD.Supernodal
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/LICENSE.CHOLMOD.Tcov
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/LICENSE.CHOLMOD.Valgrind
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/Readme.COLAMD
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/LICENSE.CSparse
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/LICENSE.CXSparse
   ${RM} ${RM_FLAGS} ${LICENSE_PATH}/${PKG}/LICENSE.UMFPACK
