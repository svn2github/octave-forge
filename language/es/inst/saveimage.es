md5="508b7ecc2d7c8917b0524fe3adf799de";rev="7239";by="Javier Enciso <j4r.e4o@gmail.com>"
-*- texinfo -*-
@deftypefn {Archivo de función} {} saveimage (@var{file}, @var{x}, @var{fmt}, @var{map})
Guardar la matriz @var{x} en @var{file} en formato imagen @var{fmt}.
Los valores válidos para @var{fmt} son
...
@item "ppm"
Formato de mapa de píxeles portátil.

@item "ps"
En formato PostScript. Tenga en cuenta que las imágenes guardadas en
...
también se guardará junto con la imagen.

Nota: si el mapa de colores contiene sólo dos entradas y estas entradas
