...
install()
{
   ...
   ${CP} ${CP_FLAGS} ${BUILDDIR}/libsrc/.libs/libnetcdf.a ${STATICLIB_PATH}
   ...
   for a in $HEADERS_INSTALL; do
      ${CP} ${CP_FLAGS} ${SRCDIR}/libsrc/$a ${INCLUDE_PATH}/`basename $a`
   done
...
uninstall()
{
   ...
   ${RM} ${RM_FLAGS} ${STATICLIB_PATH}/libnetcdf.a
