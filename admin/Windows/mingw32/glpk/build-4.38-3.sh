...
URL="http://gd.tuwien.ac.at/gnu/gnusrc/glpk/glpk-4.38.tar.gz"
...
# == check ==
#
#  make check passed, using TDM gcc-4.3.0-2, 2009-jun-16
#
...
install()
{
   ...
   ${CP} ${CP_FLAGS} ${BUILDDIR}/src/.libs/libglpk.a ${STATICLIBRARY_PATH}
...
uninstall()
{
   ...
   ${RM} ${RM_FLAGS} ${STATICLIBRARY_PATH}/libglpk.a
