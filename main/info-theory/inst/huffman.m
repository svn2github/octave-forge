...
## usage: huffman(source probability vector, {toggle})
## toggle is a 1,0 optional argument that starts building a
## code based on 1's or 0's, defaulting to 0.
##
...
##
function cw_list=huffman(source_prob,togglecode)
  if nargin < 1
...
%!assert(huffman([0.5 0.25 0.15 0.1],1), {"0","10","111","110"},0)
%!assert(huffman(0.25*ones(1,4),1),{"11","10","01","00"},0)
