...
p = abs (device.D) / 2 .* (1 + sqrt (1 + 4 * (material.ni ./ abs(device.D)) .^2)) .* ...
    (device.x <= xm) + material.ni^2 ./ ...
    (abs (device.D) / 2 .* (1 + sqrt (1 + 4 * (material.ni ./ abs (device.D)) .^2))) .* ...
    (device.x > xm);

n = abs (device.D) / 2 .* (1 + sqrt (1 + 4 * (material.ni ./ abs (device.D)) .^ 2)) .* ...
    (device.x > xm) + material.ni ^ 2 ./ ...
    (abs (device.D) / 2 .* (1 + sqrt (1 + 4 * (material.ni ./ abs (device.D)) .^2))) .* ...
    (device.x <= xm);
