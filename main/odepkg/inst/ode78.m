...
%!  vsol = ode78 (@odepkg_equations_vanderpol, [0 2], [2 0]);
%!test
%!  [vx, vy] = ode78 (@odepkg_equations_vanderpol, [0 2], [2 0]);
%!test
%!  [vx, vy, va, vb, vc] = ode78 (@odepkg_equations_vanderpol, [0 2], [2 0]);
%!test
%!  vsol = ode78 (@odepkg_equations_vanderpol, linspace (0, 0.1, 2), [2 0]);
%!test
%!  [vx, vy] = ode78 (@odepkg_equations_vanderpol, linspace (0, 0.1, 2), [2 0]);
%!test
%!  [vx, vy, va, vb, vc] = ode78 (@odepkg_equations_vanderpol, linspace (0, 0.1, 2), [0 0]);
%!test
%!  A = odeset ('MaxStep', 0.1, 'RelTol', 1e-2, 'AbsTol', 1e-3);
%!  vsol = ode78 (@odepkg_equations_vanderpol, [0 2], [2 0], A);
%!test
%!  A = odeset ('MaxStep', 0.1, 'RelTol', 1e-2, 'AbsTol', 1e-3);
%!  [vx, vy] = ode78 (@odepkg_equations_vanderpol, [0 2], [2 0], A);
%!test
%!  A = odeset ('MaxStep', 0.1, 'RelTol', 1e-2, 'AbsTol', 1e-3);
%!  [vx, vy, va, vb, vc] = ode78 (@odepkg_equations_vanderpol, [0 2], [2 0], A);
%!test
%!  A = odeset ('MaxStep', 0.1, 'RelTol', 1e-2, 'AbsTol', 1e-3);
%!  vsol = ode78 (@odepkg_equations_vanderpol, [0 2], [2 0], A, 1.2);
%!test
%!  A = odeset ('MaxStep', 0.1, 'RelTol', 1e-2, 'AbsTol', 1e-3);
%!  [vx, vy] = ode78 (@odepkg_equations_vanderpol, [0 2], [2 0], A, 1.2);
%!test
%!  A = odeset ('MaxStep', 0.1, 'RelTol', 1e-2, 'AbsTol', 1e-3);
%!  [vx, vy, va, vb, vc] = ode78 (@odepkg_equations_vanderpol, [0 2], [2 0], A, 1.2);
