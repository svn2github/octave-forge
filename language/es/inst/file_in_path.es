md5="d502f7164279cfb73c3d45a1248ef674";rev="7229";by="Javier Enciso <j4r.e4o@gmail.com>"
-*- texinfo -*-
@deftypefn {Función incorporada} {} file_in_path (@var{path}, @var{file})
@deftypefnx {Función incorporada} {} file_in_path (@var{path}, @var{file}, "all")
Retorna el nombre absoluto de @var{file} si se encuentra en @var{path}. El valor 
es @var{path} debería ser una lista separada por dos puntos de 
directorios en el formato descrito por @code{path}. Si ningún archivo se 
