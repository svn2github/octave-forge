md5="ce5b099e5795d516c03547a8a379164e";rev="6315";by="Javier Enciso <j4r.e4o@gmail.com>"
-*- texinfo -*-
@deftypefn {Funci@'on incorporada} {@var{val} =} history_file ()
@deftypefnx {Funci@'on incorporada} {@var{old_val} =} history_file (@var{new_val})
