...
$language_data = array (
    ...
    'KEYWORDS' => array(
        ...
        6 => array(
            ...
            'pink', 'pinv', 'planerot', 'playaudio', 'plot', 'plot3',
    ...
    'REGEXPS' => array(
        // Complex numbers
        1 => array(
            GESHI_SEARCH => '([+-]?\d+(\.\d+)?(e\d+)?\s*[+-]\s*([ij]\*?)?\d+(\.\d+)?(e\d+)?(\*?[ij])?)',
            GESHI_REPLACE => '\\1',
            GESHI_MODIFIERS => 'si',
            GESHI_BEFORE => '',
            GESHI_AFTER => ''
    ...
    'STYLES' => array(
        ...
        'REGEXPS' => array(
            1 => 'color: #9966FF; font-weight:bold;', // Complex number
            2 => 'color: #006600; font-weight:bold;', //Function handle
            3 => 'color: #996600; font-weight:bold;', // Package manager
        ),
        'SCRIPT' => array(
            0 => ''
        )
