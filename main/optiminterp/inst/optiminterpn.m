...
## -*- texinfo -*-
## @deftypefn {Loadable Function} {[@var{fi},@var{vari}] = } optiminterpn(@var{x},@var{y},@var{...},@var{f},@var{var},@var{lenx},@var{leny},@var{...},@var{m},@var{xi},@var{yi},@var{...})
...
## at location @var{x},@var{y},@var{...} with the error variance @var{var}.
##
## @var{lenx},@var{leny},@var{...} are correlation length in x-direction
## y-direction,... respectively. 
## @var{m} represents the number of influential points.
##
## @var{xi},@var{yi},@var{...} are the data points where the field is
