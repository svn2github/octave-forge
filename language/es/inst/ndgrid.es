md5="cb4c6afb1f2cfedbbb813b8b542e34b5";rev="7236";by="Javier Enciso <j4r.e4o@gmail.com>"
-*- texinfo -*-
@deftypefn {Archivo de función} {[@var{y1}, @var{y2}, @dots{},  @var{y}n] =} ndgrid (@var{x1}, @var{x2}, @dots{}, @var{x}n)
@deftypefnx {Archivo de función} {[@var{y1}, @var{y2}, @dots{},  @var{y}n] =} ndgrid (@var{x})
