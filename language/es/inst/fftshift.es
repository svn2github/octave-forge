md5="12238b4aaed1c866ba6d80db31a77c2b";rev="7229";by="Javier Enciso <j4r.e4o@gmail.com>"
-*- texinfo -*-
@deftypefn {Archivo de función} {} fftshift (@var{v})
@deftypefnx {Archivo de función} {} fftshift (@var{v}, @var{dim})
...
@var{v} es un arreglo, entonces lo mismo aplica a lo largo de cada dimensión.

El argumento opcional @var{dim} puede ser usado para limitar la dimensión 
a lo largo de la cual occurre la permutación.
@end deftypefn
