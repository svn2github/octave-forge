md5="27e775baaecb3b4289ca5d6575754c52";rev="7241";by="Javier Enciso <j4r.e4o@gmail.com>"
-*- texinfo -*-
@deftypefn {Archivo de función} {@var{entries} =} zip (@var{zipfile}, @var{files})
@deftypefnx {Archivo de función} {@var{entries} =} zip (@var{zipfile}, @var{files}, @var{rootdir})
