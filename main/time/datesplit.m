...
%!shared today
%! today=datevec(now); % Some tests could fail around midnight!
...
%!assert (datevec("Sep"),[today(1),9,7,0,0,0]);
%!assert (datevec("09/13"),[today(1),9,13,0,0,0]);
%!assert (datevec("2000"),[2000,1,1,0,0,0]);
%!assert (datevec("Sep00"),[2000,9,1,0,0,0]);
%!assert (datevec("15:38:09"),[today(1:3),15,38,9]);
%!assert (datevec("03:38:09 PM"),[today(1:3),15,38,9]);
%!assert (datevec("15:38"),[today(1:3),15,38,0]);
%!assert (datevec("3:38 PM"),[today(1:3),15,38,0]);
%!assert (datevec("Q3-00"),[2000,7,1,0,0,0]);
%!assert (datevec("13/03"),[today(1),3,13,0,0,0]);
%!assert (datevec("13/03/95"),[1995,3,13,0,0,0]);
%!assert (datevec("Mar.03.1962 13:53:06"),[1962,3,3,13,53,6]);
%!assert (datavec("03/13/1962"),[1962,3,13,0,0,0]);
%!assert (datavec("12/03/1962"),[1962,12,3,0,0,0]);
%!assert (datavec("95/03/13"),[1995,3,13,0,0,0]);
