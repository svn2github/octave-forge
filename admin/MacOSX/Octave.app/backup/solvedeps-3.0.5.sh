...
PCREPACK=ftp://ftp.csx.cam.ac.uk/pub/software/programming/pcre/pcre-7.6.tar.gz

LIBZPACK=http://switch.dl.sourceforge.net/sourceforge/libpng/zlib-1.2.3.tar.gz

HDF5PACK=http://ftp.debian.org/debian/pool/main/h/hdf5/hdf5_1.6.5.orig.tar.gz
HDF5DIFF=http://ftp.debian.org/debian/pool/main/h/hdf5/hdf5_1.6.5-3.diff.gz

FFTWPACK=ftp://ftp.fftw.org/pub/fftw/old/fftw-3.1.2.tar.gz
...
GLPKPACK=http://ftp.gnu.org/gnu/glpk/glpk-4.26.tar.gz
...
OCTAVEPACK=./octave-3.0.5.tar.gz
OCTAVEDIFF=./octave-3.0.5.diff
