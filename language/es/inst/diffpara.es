md5="dc757d1763ba4dff5b1544ab29f727dc";rev="7226";by="Javier Enciso <j4r.e4o@gmail.com>"
-*- texinfo -*-
@deftypefn {Archivo de función} {[@var{d}, @var{dd}] =} diffpara (@var{x}, @var{a}, @var{b})
Retorna el estimador @var{d} para el parámetro diferenciador de una 
serie integrada en el tiempo.

Las frecuencias de @math{[2*pi*a/t, 2*pi*b/T]} se usan para la estimación. 
...
se estima el parámetro diferenciador de cada columna.
