...
URL="
http://downloads.sourceforge.net/notepad-plus/npp.5.1.1.bin.zip
http://downloads.sourceforge.net/notepad-plus/npp.5.1.1.src.zip"
...
install_with_built_npp_unicode()
{
   ...
   ${CP} ${CP_FLAGS} ${BUILDDIR_NPP}/../bin/notepad++U.exe ${TARGET_PATH}
   strip ${STRIP_FLAGS} ${TARGET_PATH}/notepad++U.exe
...
http://downloads.sourceforge.net/npp-plugins/HexEditor_0_9_0_dll.zip"

PLUGINS_UNICODE="
WindowManager_1_2_1_dll
HexEditor_0_9_2_dll
Explorer_1_8_1_dll
ComparePlugin1.5.2.unicode"
PLUGINS_UNICODE_URL="
http://downloads.sourceforge.net/npp-plugins/WindowManager_1_2_1_dll.zip
http://downloads.sourceforge.net/npp-plugins/HexEditor_0_9_2_dll.zip
http://downloads.sourceforge.net/npp-plugins/Explorer_1_8_1_dll.zip
http://downloads.sourceforge.net/npp-plugins/ComparePlugin1.5.2.unicode.zip"
...
install_plugins()
{
   ( cd ${TARGET_PATH}/plugins && for a in $1; do ${TOPDIR}/${BSDTAR} x -f ${TOPDIR}/$a.zip; done )
}
