...
call :install pkg-config-0.23.tar.gz http://ftp.gnome.org/pub/gnome/binaries/win32/dependencies/pkg-config-0.23.tar.gz \mingw\share\aclocal-1.11 "--strip-components=1 pkg-config-0.23/pkg.m4"
