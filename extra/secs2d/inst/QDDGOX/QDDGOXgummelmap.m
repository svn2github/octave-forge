...
## {[@var{odata},@var{it},@var{res}]} = @
## QDDGOXgummelmap(@var{imesh},@var{Dsides},@var{Simesh},@var{Sinodes},@var{Sielements},@
##                 @var{SiDsides},@var{Intsides},@var{idata},@var{toll},@var{maxit},@
##                 @var{ptoll},@var{pmaxit},@var{stoll},@var{smaxit},@var{verbose},@var{options})
##
## @end deftypefn

function [odata,it,res] = QDDGOXgummelmap (imesh,Dsides,Simesh,Sinodes,Sielements,SiDsides,Intsides,idata,toll,maxit,ptoll,pmaxit,stoll,smaxit,verbose,options)
