md5="3f8e8e6c17005c2d26841ab0ffbc1b33";rev="6253";by="Javier Enciso <j4r.e4o@gmail.com>"
-*- texinfo -*-
@deftypefn {Funci@'on incorporada} {} fseek (@var{fid}, @var{offset}, @var{origin})
Establece el apundador del archivo en cualquier ubicaci@'on dentro del archivo @var{fid}.

El apuntador se ubica en @var{offset} caracteres apartir de @var{origin},
el cual puede ser una de las variables predefinidas @code{SEEK_CUR} (posici@'on 
...
Si la ejecuci@'on es exitosa, retorna 0, y -1 en caso de error.
