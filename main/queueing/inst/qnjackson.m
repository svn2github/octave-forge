...
##
## This function is deprecated. Please use @code{qnosjackson} instead.
##
## @seealso{qnosjackson}
##
## @end deftypefn
...
function [U_or_pi R Q X] = qnjackson( varargin )
  persistent warned = false;
  if (!warned)
    warned = true;
    warning("qn:deprecated-function",
	    "qnjackson is deprecated. Please use qnosjackson instead");
  endif
  [U_or_pi R Q X] = qnosjackson( varargin{:} );
endfunction