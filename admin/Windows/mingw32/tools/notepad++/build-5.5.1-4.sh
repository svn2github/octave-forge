...
URL="
http://downloads.sourceforge.net/notepad-plus/npp.5.5.1.bin.7z
http://downloads.sourceforge.net/notepad-plus/npp.5.5.1.src.7z"
...
http://www.alice-dsl.net/randronov/FunctionList_unicode.dll"
