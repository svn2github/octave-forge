...
-*- texinfo -*-
@deftypefn {Archivo de función} {@var{W} =} wgt1o (@var{vl}, @var{vh}, @var{fc})
Obtenga la descripción de espacio de primer orden que pondera 
la función.

Ponderar la función es necesario para el
@iftex
@tex
...
(revise @command{hinfdemo} para una aplicación de ejemplo).
@strong{Entradas}
@table @var
@item vl
...
@table @var
@item W
Función ponderada, dada en forma de estructura de datos de sistema.
@end table
@end deftypefn
