...
$language_data = array (
    ...
    'KEYWORDS' => array(
          ...
          'cell', 'cell2struct', 'cellstr', 'char', 'chdir', 'class', 'clc',
          ...
          'hypot', 'i', 'ifelse', 'ignore_function_time_stamp', 'imag', 'inf',
          'inferiorto', 'info_file', 'info_program', 'inline', 'input', 'int16',
          'int32', 'int64', 'int8', 'intmax', 'intmin', 'ipermute',
          ...
          'log1p', 'log2', 'logical', 'lower', 'lstat', 'lt',
          ...
          'nan', 'nargin', 'nargout', 'native_float_format', 'ndims', 'ne',
          ...
          'sigterm_dumps_octave_core', 'silent_functions', 'sin', 'single',
          ...
          'string_fill_char', 'strncmp', 'strncmpi', 'struct', 'struct2cell',
          ...
          'transpose', 'true', 'typeinfo', 'uint16', 'uint32', 'uint64',
          'uint8', 'umask', 'uminus', 'uname', 'undo_string_escapes', 'unlink',
          ...
          'ancestor', 'anova', 'ans', 'arch_fit', 'arch_rnd', 'arch_test',
          ...
          //Function handle
          10 => array("@([A-Za-z_][A-Za-z1-9_]*)?"),
          // Boolean
          // false and true can be used as functions too.
          // Do not highlight as boolean if followed by parentheses.
          11 => array("\b([false|true])(\b(?!(\s)*\()"),
          // Decimal
          12 => array("\b([1-9][0-9]*|0)([Uu]([Ll]|LL|ll)?|([Ll]|LL|ll)[Uu]?)?\b"),
