/*
Copyright (C) 2011 Piotr Krzyzanowski
...
The following code is based on a brilliant piece from 
'Programming Pearls' by Jon Bentley, 
see http://netlib.bell-labs.com/cm/cs/pearls/sets.cpp
*/

/* Changelog

2011-03-11 [Piotr Krzyzanowski]:
	Deal with integers represented as double variables to allow larger n;
	Use Octave's oct_randu() RNG;
	Switched loop indices to unsigned int; 
*/
