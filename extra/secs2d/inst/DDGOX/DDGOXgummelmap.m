...
## DDGOXgummelmap(@var{imesh},@var{Dsides},@var{Simesh},@var{Sinodes},@var{Sielements},@var{SiDsides},@var{idata},@var{toll},@var{maxit},@var{ptoll},@var{pmaxit},@var{verbose})
##
...
function [odata,it,res] = DDGOXgummelmap (imesh,Dsides,Simesh,Sinodes,Sielements,SiDsides,idata,toll,maxit,ptoll,pmaxit,verbose)
