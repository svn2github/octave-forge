...
!ifdef OCTAVE_CVS_VERSION
OutFile "octave_${OCTAVE_CVS_VERSION}(${OCTAVE_VERSION})_setup.exe"
!else
OutFile "octave_${OCTAVE_VERSION}_setup.exe"
!endif
...
#Section "MSYS Environment" SEC_MSYS
#SectionEnd
...
Section -Post
  ...
  ExecWait '"$INSTDIR\bin\octave.exe" -q --eval "pkg rebuild;"'
SectionEnd
