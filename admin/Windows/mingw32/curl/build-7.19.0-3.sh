...
URL="http://curl.haxx.se/download/curl-7.19.0.tar.bz2"
...
INSTALL_HEADERS="curl.h curlver.h easy.h mprintf.h stdcheaders.h types.h multi.h typecheck-gcc.h curlbuild.h curlrules.h"
