...
octave_idx_type odepkg_radau_solfcn
  ...
  if (NR > 1) odepkg_auxiliary_solstore (vt, vy, vradauoutsel, 1);
 ...
 ********************************************************************/
  ...
  odepkg_auxiliary_solstore (vtim, vsol, vradauoutsel, 0);
 ...
 *******************************************************************/
  ...
  odepkg_auxiliary_solstore (vtres, vyres, vradauoutsel, 2);
